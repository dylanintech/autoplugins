...
export default function Plugins() {
  const data = [
    ...
    },
    {
      name: "SceneX",
      description:
        "Explore image storytelling beyond pixels with the Auto-GPT SceneX Plugin.",
      firstParty: true,
    ...
    },
    {
      name: "Bing Search",
      description:
        "This search plugin integrates Bing search engines into Auto-GPT.",
      firstParty: true,
    ...
    },
    {
      name: "News Search",
      description:
        "This search plugin integrates News Articles searches, using the NewsAPI aggregator into Auto-GPT.",
      firstParty: true,
    ...
    },
    {
      name: "Random values",
      description:
        "Enable AutoGPT to generate various random numbers and strings.",
      firstParty: true,
    ...
    },
    {
      name: "Metatrader",
      description:
        "A software tool that enables traders to connect their MetaTrader 4 or 5 trading account to Auto-GPT.",
      firstParty: false,
    ...
    },
    {
      name: "Zapier",
      description:
        "This plugin allows you to easily integrate Zapier with the powerful language model GPT-4 to create various automations and applications.",
      firstParty: false,
    ...
    },
    {
      name: "AutoGPT_IFTTT",
      description:
        " This plugin allows you to easily integrate IFTTT with the powerful language model GPT-4 to create various automations and applications.",
      firstParty: false,
    ...
    },
    {
      name: "Youtube",
      description:
        "Various YouTube features including downloading and understanding",
      firstParty: false,
    ...
    },
    {
      name: "Mastodon",
      description:
        "Simple Mastodon plugin to send toots through a Mastodon account",
      firstParty: false,
    ...
    },
    {
      ...
      description:
        "Connect your TiDB Serverless database to Auto-GPT, enable get query results from database",
      firstParty: false,
      link: "https://github.com/pingcap/Auto-GPT-TiDB-Serverless-Plugin",
      contributors: [
        {
          username:
            "https://github.com/wd0517?tab=overview&from=2023-05-01&to=2023-05-10",
    ...
    },
    {
      name: "BingAI",
      description:
        "Enable Auto-GPT to fetch information via BingAI, saving time, API requests while maintaining accuracy. This does not remove the need for OpenAI API keys",
      firstParty: false,
    ...
    },
    {
      ...
      description:
        "Enable Auto-GPT to fully interact with websites! Allows Auto-GPT to click elements, input text, and scroll",
      firstParty: false,
    ...
    },
    {
      ...
      description:
        "A way to compose & run multiple Auto-GPT processes that cooperate, till core has multi-agent support",
      firstParty: false,
    ...
    },
    {
      ...
      description:
        "Allow AutoGPT to specifically request user input in continous mode",
      firstParty: false,
    ...
    },
    {
      name: "Mindware",
      description:
        "The App Store for AutoGPT. With one API key, unlock access to a growing list of plugins.",
      firstParty: false,
      link: "https://github.com/open-mindware/AutoGPT-Mindware",
      contributors: [
        {
          username: "https://github.com/open-mindware",
          pfp: "https://avatars.githubusercontent.com/u/139570166?v=4",
        },
      ],
    },
    {
    ...
    <div className="grid gap-6 grid-cols-3 grid-rows-3">
      {data.map((plugin) => (
        <Card
          ...
          github={plugin.link}
          contributers={plugin.contributors}
        />
      ))}
    </div>
  );
